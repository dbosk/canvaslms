...
\nwalsodefined{\\{NW4Ar8dO-nRuDO-2}\\{NW4Ar8dO-nRuDO-3}}\nwused{\\{NW4Ar8dO-3Q57f0-1}}\nwendcode{}\nwbegindocs{8}\nwdocspar
...
def merge_kwargs(kwargs_list,
  ...
  return new_kwargs
\nwnotused{kwargs functions caches}\nwendcode{}\nwbegindocs{22}\nwdocspar
...
class CacheGetMethods:
  ...
  def __call__(self, cls):
    ...
    return cls
\nwnotused{general class decorator for caching get methods}\nwendcode{}\nwbegindocs{27}If we want to cache several attributes, then we can simply apply this decorator 
several times.
...
\nwenddocs{}\nwbegincode{64}\sublabel{NW4Ar8dO-czaFG-1}\nwmargintag{{\nwtagstyle{}\subpageref{NW4Ar8dO-czaFG-1}}}\moddef{construct TTLCache for courses~{\nwtagstyle{}\subpageref{NW4Ar8dO-czaFG-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
self.cache = cachetools.TTLCache(ttl=timedelta(days=30), timer=datetime.now)
\nwnotused{construct TTLCache for courses}\nwendcode{}\nwbegindocs{65}\nwdocspar

Now, let's construct the decorator for the {\Tt{}Canvas\nwendquote} class to cache 
{\Tt{}get{\_}courses\nwendquote} and {\Tt{}get{\_}course\nwendquote}.
...
user.
\nwenddocs{}\nwbegincode{66}\sublabel{NW4Ar8dO-nRuDO-3}\nwmargintag{{\nwtagstyle{}\subpageref{NW4Ar8dO-nRuDO-3}}}\moddef{functions~{\nwtagstyle{}\subpageref{NW4Ar8dO-nRuDO-1}}}\plusendmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NW4Ar8dO-3Q57f0-1}}\nwprevnextdefs{NW4Ar8dO-nRuDO-2}{\relax}\nwenddeflinemarkup
...
\nwixlogsorted{c}{{construct TTLCache for courses}{NW4Ar8dO-czaFG-1}{\nwixd{NW4Ar8dO-czaFG-1}}}%
...
\nwixlogsorted{c}{{if \code{}key\edoc{} can be ignored}{nw@notdef}{\nwixu{NW4Ar8dO-2yC9my-1}}}%
