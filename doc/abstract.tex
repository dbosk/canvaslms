...
The same package can also be used directly from Python through a lazy
\texttt{canvaslms.canvas} object, letting scripts and other command-line tools
reuse the authentication, configuration, and encrypted cache of the
\texttt{canvaslms} command-line tool instead of reimplementing them.
...
\begin{minted}[firstnumber=6]{bash}
