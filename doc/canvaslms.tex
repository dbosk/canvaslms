...
\begin{minted}{text}
  pipx install canvaslms           # modern way
  python3 -m pip install canvaslms # old way
\end{minted}
...
This part explains our comprehensive testing approach.
Understanding these testing foundations is essential before diving into the implementation chapters, where you'll see tests embedded alongside the code they verify.
